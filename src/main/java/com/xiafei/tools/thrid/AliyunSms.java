...
public class AliyunSms {
    ...
    public static void main(String[] args) {
        ...
        sendSms("15210254805", smsParam, SmsTypeEnum.collect_code);
    }
    ...
    public static void sendSms(final String phone, final Map<String, String> smsParam, final SmsTypeEnum smsTypeEnum) {
        ...
        try {
            ...
            throw new RuntimeException("设置断点失败", e);
        }
        ...
        log.info("阿里云短信返回={}", JSON.toJSONString(sendSmsResponse));
    ...
    public enum SmsTypeEnum {
        ...
        collect_code {
            {
                ...
                config.setSignName("孖孖科技");
                config.setTemplateCode("xxx");
        ...
        public static SmsTypeEnum instance(final String name) {
