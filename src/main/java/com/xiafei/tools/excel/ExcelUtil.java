...
public class ExcelUtil {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String[][] dataList = new String[1048576][5];
        for (int i = 0; i < dataList.length; i++) {
            dataList[i][0] = "col" + i + "1";
            dataList[i][1] = "col" + i + "1";
            dataList[i][2] = "col" + i + "1";
            dataList[i][3] = "col" + i + "1";
            dataList[i][4] = "col" + i + "1";
        }
        String[] columnName = {"单号", "申请时间", "申请部门", "列4", "列5"};
        long start = System.currentTimeMillis();
        export(sheetName, titleName, fileName, columnName, dataList,
                new FileOutputStream(new File("C:\\code\\self\\hfepay-client\\temp\\test.xlsx")), "123");
