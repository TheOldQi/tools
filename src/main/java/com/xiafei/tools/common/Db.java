...
public final class Db {
    ...
    public static void main(String[] args) throws SQLException {
        final Connection connection1 = getMysqlConn("jdbc:mysql://127.0.0.1:3306/lease?useUnicode=true&characterEncoding=" +
                        "UTF-8&allowMultiQueries=true&rewriteBatchedStatements=true&useSSL=true",
                "root", "root");
        connection1.setAutoCommit(false);
        final Connection connection2 = getMysqlConn("jdbc:mysql://127.0.0.1:3306/lease?useUnicode=true&characterEncoding=" +
                        "UTF-8&allowMultiQueries=true&rewriteBatchedStatements=true&useSSL=true",
                "root", "root");
