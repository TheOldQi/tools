...
public class ShortUrlUtils {
    ...
    public static void main(String[] args) throws IOException {
        System.out.println(getShortUrl("https://h5.youzan.com/wscshop/goods/2orliw5izdmuz?scan=1&activity=none&from=singlemessage&redirect_count=1"));
    ...
    public static String getShortUrl(final String oriUrl) throws IOException {
        ...
        try {
            oriUrlEscape = URLEncoder.encode(oriUrl, "utf-8");
